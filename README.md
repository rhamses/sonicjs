...
[https://github.com/lane711/sonicjs/tree/legacy](https://github.com/lane711/sonicjs/tree/legacy)
          ...
          {/* <Input type='button' label='button' id='nome' />
            <Input type='checkbox' label='checkbox' id='nome' />
            <Input type='color' label='color' id='nome' />
            <Input type='date' label='date' id='nome' />
            <Input type='datetime' label='datetime' id='nome' />
            <Input type='email' label='email' id='nome' />
            <Input type='file' label='file' id='nome' />
            <Input type='hidden' label='hidden' id='nome' />
            <Input type='image' label='image' id='nome' />
            <Input type='month' label='month' id='nome' />
            <Input type='number' label='number' id='nome' />
            <Input type='password' label='password' id='nome' />
            <Input type='radio' label='radio' id='nome' />
            <Input type='range' label='range' id='nome' />
            <Input type='reset' label='reset' id='nome' />
            <Input type='search' label='search' id='nome' />
            <Input type='submit' label='submit' id='nome' />
            <Input type='tel' label='tel' id='nome' />
